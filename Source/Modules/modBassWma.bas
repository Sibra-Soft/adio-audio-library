...
' Additional filetype
Global Const BASS_FILE_ISTREAM = 2 ' IStream object
...
Global Const BASS_WMA_ENCODE_VOICE = &H100000  ' WMA Voice
Global Const BASS_WMA_ENCODE_VOICE_MIXED = &H300000 ' WMA Voice mixed mode
...
Declare Function BASS_WMA_StreamCreateFile64 Lib "basswma.dll" Alias "BASS_WMA_StreamCreateFile" (ByVal filetype As Long, ByVal file As Any, ByVal offset As Long, ByVal offsethigh As Long, ByVal length As Long, ByVal lengthhigh As Long, ByVal flags As Long) As Long
Declare Function BASS_WMA_StreamCreateFileAuth64 Lib "basswma.dll" Alias "BASS_WMA_StreamCreateFileAuth" (ByVal filetype As Long, ByVal file As Any, ByVal offset As Long, ByVal offsethigh As Long, ByVal length As Long, ByVal lengthhigh As Long, ByVal flags As Long, ByVal user As String, ByVal pass As String) As Long
...
Function BASS_WMA_StreamCreateFile(ByVal filetype As Long, ByVal file As Long, ByVal offset As Long, ByVal length As Long, ByVal flags As Long) As Long
BASS_WMA_StreamCreateFile = BASS_WMA_StreamCreateFile64(filetype, file, offset, 0, length, 0, flags Or BASS_UNICODE)
End Function

Function BASS_WMA_StreamCreateFileAuth(ByVal filetype As Long, file As Long, ByVal offset As Long, ByVal length As Long, ByVal flags As Long, ByVal user As String, ByVal pass As String) As Long
BASS_WMA_StreamCreateFileAuth = BASS_WMA_StreamCreateFileAuth64(filetype, file, offset, 0, length, 0, flags Or BASS_UNICODE, StrPtr(user), StrPtr(pass))
End Function
