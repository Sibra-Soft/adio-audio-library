...
Global Const BASS_DEVICE_LOOPBACK = 8 ' BassWasApi
...
End Function
Public Sub SYNCCALLBACK(ByVal handle As Long, ByVal Channel As Long, ByVal Data As Long, ByVal user As Long)
StreamEnded = True
End Sub
