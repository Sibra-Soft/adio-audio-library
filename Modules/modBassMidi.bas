...
End Function
Public Function MIDIFILTERPROC(ByVal handle As Long, ByVal track As Long, ByRef event_ As BASS_MIDI_EVENT, ByVal seeking As Long, ByVal user As Long) As Long
